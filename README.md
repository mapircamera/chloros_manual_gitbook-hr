...
Chloros dostupan je u 4 načina primjene:
...
Skupna obrada naredbenog retka. Savršeno za automatizaciju, skriptiranje i napredne tijekove rada. _CLI zahtijeva licencu Chloros+ za pristup._

## [Chloros API: Python SDK](api-python-sdk.md)

Programsko sučelje Python za automatizaciju i prilagođene tijekove rada. Savršeno za istraživačke kanale, integraciju s postojećim Python aplikacijama i izradu prilagođenih alata. _API zahtijeva licencu Chloros+ za pristup._

***

## Chloros+

Iako je Chloros besplatan za korištenje za većinu zadataka, možda ćete poželjeti više. Tu vam plaćena licenca za Chloros+ može koristiti. S Chloros+ licencom možete otključati nove značajke kao što su:
