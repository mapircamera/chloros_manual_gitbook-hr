...
Označavanje slika koje sadrže kalibracijske ciljeve ključni je korak koji značajno ubrzava cjevovod Chloros obrade. Prethodnim odabirom ciljanih slika eliminirate potrebu da Chloros skenira svaku sliku u vašem skupu podataka radi kalibracijskih ciljeva.
...
* Snimite ciljane slike neposredno prije i tijekom vaše sesije snimanja
...
* Držite kameru iznad mete tako da je centrirana i ispunjava oko 40-60% središta slike.
...
**Minimum:**1 ciljna slika po sesiji.**Preporučeno:** 3-5 ciljanih slika po sesiji.**Raspored najbolje prakse:**
...
3. Označite ciljne slike za **obje vrste kamera** u pregledniku datoteka
4. Chloros će koristiti odgovarajuće ciljeve za kalibraciju svake kamere
...
Ako Chloros ne otkriva ispravno vaše ciljeve, prilagodite ove postavke u [Postavke projekta](adjusting-project-settings.md):**Minimalno područje uzorka za kalibraciju:*** **Zadano**: 25 piksela
* **Povećaj** ako dobivate lažne detekcije na malim artefaktima
* **Smanjenje** ako se ciljevi ne otkrivaju**Minimalno ciljno grupiranje:*** **Zadano**: 60
* **Povećaj** ako se ciljevi dijele na više detekcija
* **Smanji** ako mete s varijacijom boje nisu u potpunosti otkrivene***
...
* Ciljane slike koje nisu označene u pregledniku datoteka
...
1. Provjerite ima li u ciljnom stupcu ispravne slike
2. Pregledajte ciljanu kvalitetu slike u pretpregledu
3. Ponovno uhvatite ciljeve ako je kvaliteta loša
4. Po potrebi prilagodite postavke otkrivanja cilja

### Problem: Lažna detekcija ciljeva

**Mogući uzroci:**

* Bijele zgrade, vozila ili pokrivač tla pogrešno se smatraju ciljevima
* Svijetle mrlje u vegetaciji
* Preniska osjetljivost detekcije

**Rješenja:**

1. Označite samo stvarne ciljne slike kako biste ograničili opseg detekcije
...
* [ ] Potvrdni okviri ciljnih stupaca označeni su za sve ciljne slike
* [ ] Ciljane slike snimljene unutar istog vremenskog okvira kao i istraživanje
...
* [ ] Za dvostruku kameru: Ciljevi označeni za obje vrste kamera
...
1. Ostavite potvrdne okvire u svim ciljnim stupcima neoznačenim
...
1. **Pregledajte svoje postavke** - Pogledajte [Prilagođavanje postavki projekta](adjusting-project-settings.md)
...
Za više informacija o samim kalibracijskim ciljevima pogledajte [Calibration Targets](../calibration-targets.md).